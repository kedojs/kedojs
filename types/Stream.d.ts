...
interface IReadableStreamBYOBReader extends ReadableStreamGenericReader {
  read(view: ArrayBufferView, options?: ReadableStreamBYOBReaderReadOptions): Promise<ReadableStreamReadResult<any>>;
  releaseLock(): void;
}
...
declare module "@kedo:int/std/stream" {
  ...
  export class ReadableStream {
    ...
    get locked(): boolean;
    cancel(reason: any): Promise<void>;
    static from<T>(asyncIterable: Iterable<T> | AsyncIterable<T>): ReadableStream;
  ...
  export class ReadableStreamBYOBReader implements IReadableStreamBYOBReader {
    ...
    read(view: ArrayBufferView, options?: ReadableStreamBYOBReaderReadOptions | undefined): Promise<ReadableStreamReadResult<any>>;
    cancel(reason: any): Promise<void>;
    get closed(): any;
    releaseLock(): void;
  }

  export class ReadableStreamDefaultReader implements IReadableStreamDefaultReader {
    constructor(stream: ReadableStream);
    get closed(): any;
    cancel(reason: any): Promise<void>;
    read(): any;
